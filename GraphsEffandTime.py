...
handleineff = open("./Metrics/inlab.csv", 'rb')
handleouteff = open("./Metrics/outlab.csv", 'rb')
handleintimes = open("./Metrics/inlabtimes.csv", 'rb')
handleouttimes = open("./Metrics/outlabtimes1.csv", 'rb')
